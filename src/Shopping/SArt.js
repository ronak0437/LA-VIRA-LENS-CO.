...
import homedecor from '../Assets/Category/frame2.webp';
                            ...
                            return (
                                <div className='learning md:grid-cols-2'  >
                                    <Card  style={{display:'flex',width:955,height:300,marginTop:50}}>
                                        ...
                                        <Card.Body style={{ maxWidth:'100%',marginTop:50,borderRadius:20,padding:10 ,backgroundColor:'pink',height:200,width:1200}}>
                                            <Card.Title>{e.pname}</Card.Title><br />
                                            <div>
                                            <span style={{ paddingRight: '40px' }}>{e.cType}</span>
                                                 {'\u20B9'} {e.price}
                                            </div>

                                            <Card.Text style={{maxWidth:'80%',marginLeft:'30px'}}><br/>
                                                {e.desc}
                                            </Card.Text>
